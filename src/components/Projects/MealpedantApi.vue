<template>
	...
	<br>
	<br>
	A previous, now outdated and unmaintained, Typescript <AHref href='https://github.com/mrjackwills/mealpedant_api/tree/typescript' text='branch' /> is available in the GitHub repository.
