...
const href_dockerhub = 'https://hub.docker.com/r/mrjackwills/havn';
const href_crates ='https://crates.io/crates/havn';
const href_ghcr = 'https://ghcr.io/mrjackwills/havn';

onMounted(() => {
	imageModule().set_image(Gif);
